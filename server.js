...
/* ---------------- تور ایمنی ----------------
   هیچ خطای پیش‌بینی‌نشده‌ای نباید کل سرور را بکشد.
   خطا ثبت می‌شود و سرور به کارش ادامه می‌دهد. */
process.on('unhandledRejection', e => {
  console.error('[safety] خطای ناگرفته (promise):', e && e.message || e);
});
process.on('uncaughtException', e => {
  console.error('[safety] خطای ناگرفته:', e && e.message || e);
});
